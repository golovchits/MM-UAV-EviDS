#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# EviDS-UAV Experiment 3 — Condition (c): Evidential + ADFM
#
# Replaces sigmoid heads with evidential Dirichlet heads on both YOLOX
# streams. ADFM feature-level channel-attention fusion is retained.
# Each stream produces per-modality Dirichlet outputs (α, u).
...
class Exp(MyExp2):
    def __init__(self):
        ...
        # Paths (update for Snellius scratch)
    ...
    def get_model(self):
        from yolox.models import YOLOX2
        from yolox.models.yolo_head_evidential import YOLOXHeadEvidential
        from yolox.models.yolo_pafpn2_evidential_adfm import YOLOPAFPN2
