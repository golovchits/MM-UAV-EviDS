#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# EviDS-UAV Experiment 3 — Condition (e): Evidential + DS Fusion
#
# Core EviDS-UAV for E3. Evidential heads on both streams.
# OGAA spatial alignment retained, ADFM removed.
# DS evidence fusion at decision level (after heads).
...
class Exp(MyExp2):
    ...
    def get_model(self):
        ...
        if getattr(self, "model", None) is None:
            ...
            self.model = YOLOX2DS(backbone, head, head2, ds_fusion)
        ...
        # Freeze backbone + FPN, train Fusion (OGAA only) + heads + DS fusion
